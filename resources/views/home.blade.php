    ...
    <main class="w-full flex flex-col gap-10 justify-start items-center mb-10">
        ...
        <section class="w-11/12 flex flex-col gap-4 justify-start items-start">
            <div class="flex flex-col gap-1 justify-start lg:items-start items-center">
                ...
                <p class="text-[#ADB4B2] max-lg:text-center max-lg:text-sm">انتخاب هایی که بیشتر از همه مورد توجه کاربران قرار گرفته است</p>
            </div>
                ...
                <div
                    ...
                    <div class="w-full h-1/2 flex justify-center items-center relative">
                        <a href={{ route('product.show', [$product->id]) }} class="block">
                            <img src="{{ asset('storage/'.$product->image)}}" alt="" class="max-w-full max-h-24 lg:max-h-42">
                        </a>
                        @if($product->percent)
                        <span
                    ...
                    <div class="w-full h-1/2 flex flex-col gap-1 justify-start items-start">
                        <a href={{ route('product.show', [$product->id]) }} class="lg:text-lg text-sm font-bold">{{ $product->title }}</a>
