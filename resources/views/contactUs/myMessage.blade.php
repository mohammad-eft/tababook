            ...
            <form class="flex flex-col gap-5" action="{{ route('contactUs.deleteAll') }}" method="post">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="px-1 w-full lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100">
                            <span class="block w-10 lg:w-full text-center">ردیف</span>
                        </div>
                        <div class="px-1 w-full lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-20 lg:w-full">عنوان</span>
                        </div>
                        <div class="px-1 w-full lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-[120px] lg:w-full">توضیحات</span>
                        </div>
                        <div class="px-1 w-full lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-24 lg:w-full">شماره تماس</span>
                        </div>
                        <div class="px-1 w-full lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-4">
                    ...
                    <div class="bg-white divide-y divide-[#f1f1f4]">
                        @php
                            $i = 1;
                         @endphp
                        @foreach (Auth::user()->contactUs as $contactUs)
                                    <div
                                        ...
                                        <div
                                            ...
                                            <span class="block w-24 lg:w-full">{{ $contactUs->phoneNumber }}</span>
                                        </div>

                                      
                                            <div class="lg:w-full w-[220px] lg:col-span-3 grid grid-cols-3 divide-x divide-[#f1f1f4] items-center w-[300px]">

                                                <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3 justify-center">
                                                    <li class="flex justify-center">
                                                        <a href="{{ route('contactUs.show', [$contactUs]) }}"
                                                    ...
                                                    <li class="flex justify-center">
                                                        <a href="{{ route('contactUs.edit', [$contactUs]) }}"
